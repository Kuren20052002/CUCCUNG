...
import { Lock, Mail, Baby, ArrowRight, Eye, EyeOff } from "lucide-react"
...
export default function LoginPage() {
  ...
  const [lastAttempt, setLastAttempt] = useState({ email: "", password: "" })
  const router = useRouter()

  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    
    // Prevent re-submitting the same wrong credentials too quickly
    if (email === lastAttempt.email && password === lastAttempt.password) {
      toast.error("Vui lòng thay đổi thông tin trước khi thử lại")
      return;
    }

    setIsLoading(true)
    setLastAttempt({ email, password })
  ...
  return (
    <div className="min-h-screen h-svh flex items-center justify-center p-4 bg-[radial-gradient(circle_at_top_left,_#fff5f7_0%,_#f0f7ff_100%)] overflow-y-auto overflow-x-hidden scrollbar-hide">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8 animate-fade-in-down">
          ...
          <h1 className="text-3xl font-bold text-gray-800 tracking-tight">Chào mừng quay lại</h1>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-8 shadow-2xl shadow-gray-200/50 border border-white animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-white border border-gray-200 rounded-2xl text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-pink-300 focus:border-pink-400 outline-none transition-all duration-300"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 bg-white border border-gray-200 rounded-2xl text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-pink-300 focus:border-pink-400 outline-none transition-all duration-300"
                  placeholder="••••••••"
                />
                <button
                  type="button"
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400 text-sm">
              Bạn gặp vấn đề? <a href="mailto:support@cuccung.vn" className="text-pink-400 hover:underline font-medium">Hỗ trợ kỹ thuật</a>
            </p>
          </div>
        </div>
